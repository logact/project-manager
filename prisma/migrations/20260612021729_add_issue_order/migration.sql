...
INSERT INTO "new_Issue" ("assignee_id", "created_at", "cycle_id", "description", "id", "identifier", "label_ids", "priority", "project_id", "state", "team_id", "title", "updated_at") SELECT "assignee_id", "created_at", "cycle_id", "description", "id", "identifier", "label_ids", "priority", "project_id", "state", "team_id", "title", "updated_at" FROM "Issue";
DROP TABLE "Issue";
